...
// ErrInvalidRepoFormat belongs to the model layer because parsing is RepoSpec's responsibility
...
// It encapsulates the "owner/repo" parsing rules (strings, validation)
