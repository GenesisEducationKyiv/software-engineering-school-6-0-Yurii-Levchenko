...
Ключове міркування: при простій схемі (2 таблиці, прямі queries без JOINів) переваги ORM не переважують втрату прозорості. sqlx дає зручність GORM (struct mapping) при меншій складності реалізації.
